...
function weightInChickens(kilograms) {
  ...
  if (Number.isNaN(kilograms)) {
    paragraph.innerText += `Invalid input. Please refresh the page and enter a valin number.`;
  } else {
    paragraph.innerText += `If your weight is ${input}kg, then your weight in chickens is ${chickenWeight} chickens`;
  }
}
