...
Create a function that takes a number and returns its corresponding month name as a string.
...
let month = parseInt(prompt("Enter the number of the month to see its name: "));
let result = numberToMonth(month);
